...
original file "train_with_wav2vec.py" from https://drive.google.com/drive/folders/19G2Zm8896QSVDqVfs7PS_W86-K0-5xeC
this is the model download for the german model provided here: https://github.com/speechbrain/speechbrain/tree/0110f4e65e2c866e18d49c1a82c7ef00fe4959ca/recipes/CommonVoice/ASR/CTC
...
if __name__ == "__main__":
    ...
    decodings_file = f"outputs/mcv_{trial_id}_decodings_{ensemble_size}.json"
    # %%

    if not os.path.isfile(decodings_file):
        decodings = inference_brain_on_dataset_with_uncertainty(
            asr_brain, test_data, ensemble_size, tokenizer, hparams, subset=subset
        )
    ...
    # %%
    evaluate_uncertainties(decodings, trial_id, ensemble_size, "mcv")
